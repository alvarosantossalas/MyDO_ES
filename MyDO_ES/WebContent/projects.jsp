...
<body>
	...
	<div id="centro">
		...
		<p class="text-center">
		<br>
			Podrás gestionar tus proyectos manualmente en todo momento. MyDO
			ofrecerá un sistema automatizado en el cual <br> podrá ordenar
			las tareas en proyectos siguiendo un algoritmo basado en la casilla
			"asunto" de cada tarea.
		</p>
	</div>
	<br><br>
