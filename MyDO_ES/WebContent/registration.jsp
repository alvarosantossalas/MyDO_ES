        ...
        <div id="centro-registro" style="width: 50%; margin: 15px auto 15px;">
            <form>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="_username" placeholder="Nombre de usuario">
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="_password_1">Contraseña</label>
                        <input type="password" class="form-control" id="_password_1" placeholder="Contraseña" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="_password_2">Repite contraseña</label>
                        <input type="password" class="form-control" id="_password_2" placeholder="Repite contraseña" required>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="_name">Nombre</label>
                        <input type="email" class="form-control" id="_name" placeholder="Nombre" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="_lastname">Apellidos</label>
                        <input type="password" class="form-control" id="_lastname" placeholder="Apellidos" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="_email">Correo electrónico</label>
                    <input type="text" class="form-control" id="_email" placeholder="Correo electrónico">
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="_phone">Teléfono</label>
                        <input type="text" class="form-control" id="_phone">
                    </div>
                ...
                <button type="submit" class="btn btn-primary">Registrar mi cuenta </button>
            </form>
        </div>
        <br>
        <footer id="myFooter">
